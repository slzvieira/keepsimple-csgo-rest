...
public class KillController {
    ...
    public ResponseEntity<Kill> postKill(@RequestBody Kill kill) throws JsonProcessingException {

//        if (log.isDebugEnabled()) {
//            log.info("KillController#postKill() - Inicio - "
//                            + new ObjectMapper().writeValueAsString(kill));
//            log.info("KillController#postKill() - Inicio - "
...
//        }
        ...
        log.info("KillController#postKill() - Fim");
